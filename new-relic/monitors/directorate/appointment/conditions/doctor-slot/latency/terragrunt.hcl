...
inputs = {
  nrql_alert_condition_name = "Doctor Slot Latency"
  nrql_alert_condition_description = "Doctor Slot Latency"
  nrql_alert_condition_policy_ids = []
  nrql_alert_condition_enabled = true
  nrql_alert_condition_query = "SELECT percentile(duration, 95) * 1000 as 'Latency' FROM Transaction where request.uri='/api/rumah-sakit/v1/hospitals/personnel/schedule/slots' since 15 minutes ago"
