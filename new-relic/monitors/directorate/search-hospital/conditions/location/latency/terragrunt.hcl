...
inputs = {
  nrql_alert_condition_name = "Hospital Location Latency"
  nrql_alert_condition_description = "Hospital Location Latency"
  nrql_alert_condition_policy_ids = []
  nrql_alert_condition_enabled = true
  nrql_alert_condition_query = "SELECT percentile(duration, 95) * 1000 as 'Latency' FROM Transaction where request.uri='/api/rumah-sakit/v1/hospitals/locations' since 15 minutes ago"
